# TP1-EVF-2 : Session de test du TP1

Date : <!-- %: SEANCE_EVF_2 -->[Séance 3](/01-deroulement/03/)<!-- %; -->. Comme c'est le premier fois qu'on va créer des builds de projet, on va le préparer ensemble en classe.
